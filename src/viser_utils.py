...
class PointCloudViewer:
    ...
    def _connect_client(self, client: viser.ClientHandle):
        ...
        # # ! not supporting this function for now
...
class PointCloudViewerLignt(PointCloudViewer):
    # ! a lite version for visualizing off-line data only.
    def __init__(
        self,
        model,
        # state_args,
        ...
        super().__init__(model, pc_list, color_list, conf_list, cam_dict, image_mask, edge_color_list,
                         device, port,show_camera, vis_threshold, size)