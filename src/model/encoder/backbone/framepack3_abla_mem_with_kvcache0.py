...
class FramePack3Rv3_Abla_Mem_with_KVCache0(FramePack3Rv3):
    ...
    def _rnn_decoder_causal_pack(self, mem_feat, f_nextpack, ress, f_state,
        ...
        for idx, blk_siamese in enumerate(self.dec_blocks):  # ! 12 blocks of decoder.
            ...
            if self.gradient_checkpointing and self.training and torch.is_grad_enabled():
                def create_custom_forward(module_siamese):
                    def custom_forward(*inputs):
                        # f_state as the q
                        f_state, _ = module_siamese(
