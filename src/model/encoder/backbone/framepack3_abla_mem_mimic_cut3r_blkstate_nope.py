...
class FramePack3Rv3_Abla_Mem_cut3r_blkstate_nope(FramePack3Rv3):
    ...
    def __init__(self, cfg: BackboneCrocoCfg, d_in: int) -> None:
        ...
        del self.learnable_B_token, self.learnable_frame0_token
    ...
    def _rnn_decoder_initialize(self, f_state, f1, pos_1, pos_fstate, *args, **kwargs):
        ...
        for idx, (blk_siamese, blk_state) in enumerate(zip(
                self.dec_blocks, self.dec_state_blocks)):  # ! 12 blocks of decoder.
